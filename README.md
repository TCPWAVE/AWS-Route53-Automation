# Scope 
AWS Route53 DNS Automation to the TCPWave IPAM is the intended scope of this article. This automation helps add or delete hosted zone resource records to TCPWave IPAM
whenever the resource records receive an update in the AWS Route53.
...
The following section explains the setup in TCPWave IPAM and AWS required for the automation.
